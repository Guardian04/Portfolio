...
export default function ProfileBody() {
    ...
    const aboutMe : About = {
        Country: t("aboutValues.Country"),
        City: t("aboutValues.City"),
        Age: 19
    };
    ...
    return (
        <div className="profile-body">
            <div className="profile-body-content">
                ...
                <div className="profile-body-download">
                    <div className="profile-body-download-btn" onClick={() => handleDownloadCV()}>
